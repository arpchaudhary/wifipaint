...
class GridMaker{
	...
	public function __construct($length, $word_list){
		...
		$this->grid->setData(new Point(0,0), "S");
		$this->grid->setData(new Point(1,0), "O");
		$this->grid->setData(new Point(2,0), "M");
		$this->grid->setData(new Point(3,0), "E");
		$this->grid->setData(new Point(4,0), "R");
		$this->grid->setData(new Point(5,0), "A");
		$this->grid->setData(new Point(6,0), "N");
		$this->grid->setData(new Point(7,0), "D");
		$this->grid->setData(new Point(8,0), "O");
		$this->grid->setData(new Point(0,0), "O");
